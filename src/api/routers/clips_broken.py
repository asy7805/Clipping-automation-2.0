    ...
    try:
        ...
        def get_all_clips_from_storage():
            ...
            try:
                ...
                channels = sb.storage.from_(bucket).list('raw', {'limit': 100})
                ...
                for channel_folder in channels:
                    ...
                    try:
                        files = sb.storage.from_(bucket).list(f'raw/{channel_name_item}', {'limit': 1000})
                        ...
                        for file_item in files:
                            ...
                            if file_name.endswith('.mp4'):
                                file_path = f"raw/{channel_name_item}/{file_name}"
